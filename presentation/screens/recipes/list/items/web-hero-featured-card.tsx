...
import { WebHeroActionRow } from '@presentation/screens/recipes/list/items/web-hero-action-row';
import {
  HERO_OVERLAY_DEEP,
  HERO_OVERLAY_MID,
  HERO_OVERLAY_FADE,
} from '@presentation/screens/recipes/list/model/web-hero-constants';
